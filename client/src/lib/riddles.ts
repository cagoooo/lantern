...
export const riddles: RiddleWithAnswers[] = [
    ...
    { id: 3, category: "師長", question: "委鬼之木成一姓，博學才俊彥士名。", hint: "猜一石小師長", answers: ["魏彥士"], explanation: "「委」和「鬼」組合成「魏」字，這是姓氏。後半句提到「彥士」就是名字。合起來就是石門國小的師長「魏彥士」。" },
    { id: 4, category: "師長", question: "耳東傳芳草頭方，玉冊珊瑚現芳名。", hint: "猜一石小師長", answers: ["陳芳珊"], explanation: "「耳」＋「東」＝「陳」（姓氏）。「草字頭」＋「方」＝「芳」。「珊瑚」取第一個字「珊」。合起來就是「陳芳珊」。" },
    { id: 5, category: "文化", question: "歲末團圓日，圍爐聚一堂，魚肉滿桌香，幸福萬年長。", hint: "猜一過年活動", answers: ["圍爐", "吃年夜飯", "年夜飯"], explanation: "過年時全家人團聚在一起吃年夜飯，古時候大家圍著火爐坐在一起，所以這個活動叫「圍爐」。代表團圓和溫暖。" },
    ...
    { id: 8, category: "地名", question: "空中霸王。", hint: "猜一縣市", answers: ["嘉義"], explanation: "空中的霸王就是「鷹」（老鷹）。「鷹」的台語發音類似「義」，加上「嘉」字，就是台灣的「嘉義」縣市。" },
